<template>
  <div class="face-location-main">
    ...
    <div class="submit">
      <el-button type="primary" @click="onSubmit" v-permission="'faceRecognitionMan:btn_detect'">开始分析</el-button>
      <el-button type="primary" class="col1" @click="onSubmit('deep')" v-permission="'faceRecognitionMan:btn_deep_detect'">深度分析</el-button>
    </div>

<template>
  <div class="face-comparison-main">
    ...
    <div class="submit">
      ...
      <el-select v-model="submitQuery.callMethod" placeholder="请选择">
        <el-option v-for="item in callMethodsOption" :key="item.value" :label="item.label" :value="item.value"></el-option>
      </el-select>

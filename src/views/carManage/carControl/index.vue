<template>
  <div class="app-container">
    ...
    <el-form class="form" @keyup.enter.native="getTableList">
      <span>关键字</span>
      <el-input size="mini" @keyup.enter.native="getTableList" placeholder="车牌号/业主姓名" v-model="listQuery.condition"></el-input>
    ...
    <el-dialog :title="form.id?'编辑':'添加'" :visible.sync="isFormDialog" width="500px">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
        ...
        <el-form-item label="备　　注" prop="cameraDesc" class="m0">

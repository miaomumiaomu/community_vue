    ...
    <el-dialog title="同行详情" class="detail-layer body0" :visible.sync="isDialogDateil" width="850px">
      ...
      <el-table :data="detailData.records" class="table" height="calc(100vh - 540px)">
        <el-table-column align="center" label="头像" width="80">
          <template slot-scope="scope">
            <img-show width="48px" height="48px" txt="暂无头像" :img-src="scope.row.snapImgBase"></img-show>
          </template>
        </el-table-column>
        <el-table-column align="center" label="背景图">
          <template slot-scope="scope">
            <a @click="onLookPicture(scope.row.snapBgUrl)">
              <img-show height="48px" txt="暂无背景" :img-src="scope.row.snapBgUrl" class="pic"></img-show>
            </a>
          </template>
        </el-table-column>

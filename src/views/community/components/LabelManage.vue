<template>
  <div class="label-manage">
    ...
    <!-- 表格模式 S -->
    <el-table ref="listTabel" :data="listData.rows" height="calc(100vh - 310px)" v-loading.body="listLoading" highlight-current-row @selection-change="onListChange">
...
export default {
  ...
  watch: {
    data(val) {
      if (val) {
        this.listQuery.jlxxqCode = val.jlxxqCode;

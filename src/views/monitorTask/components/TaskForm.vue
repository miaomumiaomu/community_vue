<template>
  <el-dialog :title="id?'编辑布控':'添加布控'" class="task-form body0" :visible.sync="isFormDialog" width="640px">
    ...
    <div slot="footer">
      ...
      <template v-else>
        <el-button size="mini" type="primary" @click="onSubmit" v-permission="'monitorMan:btn_edit'">保存</el-button>
...
import {
  ...
  putMonitorTask,
  getMonitorTask
} from "@/api/monitorTask/index";
import { getSmsSelect } from "@/api/Linkage/msgLinkage/index";
import { getAppSelect } from "@/api/Linkage/appLinkage/index";

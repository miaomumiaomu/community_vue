  ...
  <el-dialog class="role-copy body0" title="角色复制" :visible.sync="isCopyDialog" width="1000px">
    <el-row>
      ...
      <el-col :span="12" class="menu">
        ...
        <el-tree class="filter-tree" node-key="id" :data="treeData" show-checkbox :expand-on-click-node="false" highlight-current :props="defaultProps" :filter-node-method="filterNode" ref="departTree" :check-strictly="true" @node-click="getNodeData" default-expand-all>

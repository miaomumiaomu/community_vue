<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="common-tool">
      ...
      <div class="right">
        <el-button class="txt-btn" v-permission="'elementMan:btn_add'" size="mini" @click="onItemAdd" type="text" icon="el-icon-plus">添加</el-button>
        <el-button class="txt-btn" v-permission="'elementMan:btn_delete'" size="mini" icon="el-icon-delete" type="text" @click="onItemDelete()" style="margin-left: 0px">删除</el-button>
      </div>
    </div>
    <el-table :data="listData.rows" v-loading.body="listLoading" border fit highlight-current-row height="calc(100vh - 302px)" style="width: 100%" @selection-change="onListChange">
      <el-table-column align="center" type="selection" width="45" />
      <el-table-column align="center" fixed="right" label="操作" width="80">
        <template slot-scope="scope">
          <el-button v-permission="'elementMan:btn_edit'" size="mini" type="success" @click="onItemEdit(scope.row)">
            编辑
          </el-button>
        </template>
      </el-table-column>
      <el-table-column width="200px" align="center" label="资源编码" prop="code" />
      <el-table-column align="center" label="资源类型" prop="type" />
      <el-table-column width="200px" align="center" label="资源名称" prop="name" />
      <el-table-column align="center" label="资源地址" prop="uri" />
      <el-table-column width="120" align="center" label="资源请求类型" prop="method" />
    </el-table>
    ...
    <el-dialog :title="form.id?'编辑资源':'创建资源'" :visible.sync="dialogFormVisible" width="500px">
...
import {
  ...
  deleteMenuContent,
  putMenuContent
} from "@/api/basicConfig/menuContentManage/index";
export default {
  name: "menu-element",
  data() {
    return {

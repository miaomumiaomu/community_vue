<template>
  <div class="app-container calendar-list-container">
    <div ref="filter" class="p10">
      ...
      <el-date-picker size="mini" v-model="value5[1]" class="filter-item" type="datetime" format="yyyy-MM-dd HH:mm:ss" @change="handleEndTimeChange" placeholder="请选择结束时间" :picker-options="singlePickerOptions(value5[1])" />

<template>
  <div class="app-container dataCenter-clustering-main">
    <div class="info" v-for="(item, index) in classifyData" :key="index" v-if="classifyData.length">
      ...
      <swiper class="swiper" ref="swiper" :options="swiperOption">
        <swiper-slide v-for="(face,index) in item.faceSnaps" :key="index">
          <img-show class="pic" width="100px" height="100px" txt="暂无头像" :img-src="classifyData.snapIds[face.snapId].imgBase">
    ...
    <div class="submit">
      <el-button type="primary" @click="onOpen" v-permission="'snapMan:btn_classify'">聚类分析</el-button>
    </div>
    ...
    <el-dialog title="抓拍数据" class="list-layer body0" :visible.sync="dialogVisible" width="1060px">
      <div class="filter-container">
        ...
        <el-date-picker size="mini" v-model="datePicker[0]" class="filter-item w2" type="datetime" format="yyyy-MM-dd HH:mm:ss" @change="onStartTimeChange" placeholder="请选择开始时间" :picker-options="singlePickerOptions()" />
        <el-date-picker size="mini" v-model="datePicker[1]" class="filter-item w2" type="datetime" format="yyyy-MM-dd HH:mm:ss" @change="onEndTimeChange" placeholder="请选择结束时间" :picker-options="singlePickerOptions(datePicker[0])" />

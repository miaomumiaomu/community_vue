  ...
  <el-dialog :title="`${data.handleFlag == 1?'查看':'处理'}告警信息`" class="dispose-layer body0" width="600px" :visible.sync="isDisposeDialog" v-if="data" append-to-body>
    ...
    <div slot="footer">
      <template v-if="data.handleFlag == 0">
        <el-button size="mini" type="primary" @click="onSubmit" v-permission="'alarmMan:btn_handle_alarm'">保 存</el-button>
...
<script>
import { postAlarmHandle } from "@/api/dataCenter/alarmNews/index";

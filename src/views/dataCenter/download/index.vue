            ...
            <div class="box">
              <div class="list" v-if="noDetectListData.length > 0">
                <div class="item" v-for="(item,index) in noDetectListData" :key="index">
                  ...
                  <span>{{item}}</span>
                  <el-button type="text" size="mini" @click="onDeleteFile(0,item)" v-permission="'commonMan:btn_no_detect_delete'">
                    <i class="el-icon-delete"></i>
                  </el-button>
                  <el-button type="text" size="mini" @click="onDownloadFile(0,item)" v-permission="'commonMan:btn_no_detect_download'">
            ...
            <div class="box">
              <div class="list" v-if="abnormalListData.length > 0">
                <div class="item" v-for="(item,index) in abnormalListData" :key="index">
                  <svg-icon icon-class="folder" />
                  <span>{{item}}</span>
                  <el-button type="text" size="mini" @click="onDeleteFile(1,item)" v-permission="'commonMan:btn_no_feature_delete'">
                    <i class="el-icon-delete"></i>
                  </el-button>
                  <el-button type="text" size="mini" @click="onDownloadFile(1,item)" v-permission="'commonMan:btn_no_feature_download'">
                    <i class="el-icon-download"></i>
                  </el-button>
                </div>
              </div>

      ...
      <el-row>
        <el-col :span="7" class="left-form">
          <div class="croppa-box">
            <croppa v-model="croppa" :initial-image="pictureQuery.image" @loading-end="onImageLoading" :class="{error: croppaError}" accept=".jpeg,.jpg,.png,.bmp" placeholder=" " :width="120" :height="120" :quality="2" :zoom-speed="10" :disabled="false" :prevent-white-space="true" :show-remove-button="true">
          ...
          <el-form-item label-width="0" v-permission="'faceRecognitionMan:btn_search'">
